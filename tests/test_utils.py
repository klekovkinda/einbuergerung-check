...
from lib.utils import build_statistics_html_message, PROMOTION_MESSAGE
...
class TestBuildStatisticsHtmlMessage(unittest.TestCase):
    def test_statistics_html_message_all_zeros(self):
        ...
        self.assertIn(
            "Between <strong>00:00:00</strong> and <strong>00:00:00</strong>, I checked <strong>0</strong> times.",
            msg)
    ...
    def test_statistics_html_message_with_successful_notifications(self):
        msg = build_statistics_html_message(start_at="08:00:00",
                finish_at="09:00:00",
                execution_times=5,
    ...
    def test_statistics_html_message_no_successful_notifications(self):
        msg = build_statistics_html_message(start_at="10:00:00",
                finish_at="11:00:00",
                execution_times=3,
        ...
        self.assertIn(
            "Between <strong>10:00:00</strong> and <strong>11:00:00</strong>, I checked <strong>3</strong> times.",
            msg)
...
"""
    ...
    def test_statistics_html_message_singular(self):
        msg = build_statistics_html_message(start_at="07:00:00",
                finish_at="08:00:00",
                execution_times=1,
...
"""
    ...
    def test_statistics_html_message_singular_mixed(self):
        msg = build_statistics_html_message(start_at="06:00:00",
                finish_at="07:00:00",
                execution_times=1,
                successful_notifications=1,
                available_dates=2,
                ...
                missing_users=2)
        self.assertIn(
            "I managed to find an open slot and sent you <strong>1</strong> notification for <strong>2</strong> different dates!",
            msg)
